    ...
    public class MockEmployeeRepository : IEmployeeRepository
    {
        ...
        public MockEmployeeRepository()
        {
            _employeesList = new List<Employee>{
                new Employee() { Id = 1, Name = "Vipin", Department = Department.Finance, Email = "vipin@accops.com" },
                new Employee() { Id = 2, Name = "Rajiv", Department = Department.Sales, Email = "rajiv@accops.com" },
                new Employee() { Id = 3, Name = "Dev", Department = Department.IT, Email = "dev@accops.com" },
                ...
                new Employee() { Id = 7, Name = "Arjun", Department = Department.IT, Email = "arjun@accops.com" },
                new Employee() { Id = 8, Name = "Risabh Rai", Department = Department.Finance, Email = "risabh.rai@accops.com" }
            };
        }
